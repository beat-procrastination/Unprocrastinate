...
function saveDataErinnerung() {
const container = document.getElementById('erinnerungListe');
const erinnerungElements = container.querySelectorAll('.timerContainer');
...
originalDiv.className = 'timerContainer';
    ...
    <div class="hidde">
        <div class="erinnerungDetails">
            <div class="datumContainer">
                <input id="inputDate" class="inputErinnerungDetails" placeholder="Datum" type="text" value="${data.date}">
                <input id="inputTime" class="inputErinnerungDetails" placeholder="Uhrzeit" type="text" value="${data.time}">
            </div>
        </div>
    </div>
`;
...
originalDiv.innerHTML = `
    ...
    <div class="hidde">
        <div class="erinnerungDetails">
            <div class="datumContainer">
                <input id="inputDate" class="inputErinnerungDetails" placeholder="Datum" type="text">
                <input id="inputTime" class="inputErinnerungDetails" placeholder="Uhrzeit" type="text">
            </div>
        </div>
    </div>
`;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const data = Array.from(erinnerungElements).map((element, index) => {
        const date = element.querySelector('#inputDate').value;
        const time = element.querySelector('#inputTime').value;
        const name = element.querySelector('.timerName').value;
